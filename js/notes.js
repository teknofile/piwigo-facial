$(function() {
  ...
  // ==========================================================
  // Step 1: Use the event to add your tpl (for this example: facial/template/notes.tpl)
  // to the “user_list” page (see the tpl to find out what you need to put there).
  // Example event => "add_event_handler('loc_end_admin', 'facial_add_tab_users_modal', EVENT_HANDLER_PRIORITY_NEUTRAL, $admin_file);"
  //
  ...
  // go to the “install” function in the “maintain.class.php” file (found in plugins/facial/maintain.class.php)
  ...
  // Example event => "add_event_handler('ws_add_methods', 'facial_ws_add_methods', EVENT_HANDLER_PRIORITY_NEUTRAL, $ws_file);"
  //
  // NEW IN PIWIGO 15:
  ...
  plugin_add_tab_in_user_modal(
    ...
    () => {
      ...
      console.log('get data facials_textarea');
    }
  );
  ...
  // To do this, go to the “install” function in the “maintain.class.php” file (found in plugins/facial/maintain.class.php)
  ...
  // Follow the examples in the respective functions “facial_ws_users_setInfo” and “facial_ws_users_getList”.
  //
  // NEW IN PIWIGO 15:
  // 3. Use the plugin_add_tab_in_user_modal function to add a new tab to the user modal with the following parameters:
  // => param 1 (string): Name of the tab
